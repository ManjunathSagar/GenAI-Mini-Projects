...
class DayPlan(BaseModel):
    ...
    flight: Optional[str] = Field(..., description="Flight information")


class Itinerary(BaseModel):
    name: str = Field(..., description="Name of the itinerary, some name you define")
...
class TravelAgentCrew():
    ...
    def crew(self) -> Crew:
        ...
        return Crew(
            agent=self.agents,#Automatically created by the @agent decorator
            tasks=self.tasks,#Automatically created by the @tasks decorator
